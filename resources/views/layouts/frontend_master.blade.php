                ...
                <div class="row">
                    ...
                    <div class="col-md-4 col-lg-2 col-sm-5 col-4">
                        <ul class="search-cart-wrapper d-flex">
                            ...
                            <li>
                                <a href="javascript:void(0);"><i class="flaticon-like"></i> <span>{{App\Carts::where('ip_address',request()->ip())->count()}}</span></a>
                                <ul class="cart-wrap dropdown_style">
                                  <?php foreach (App\Carts::where('ip_address',request()->ip())->get() as $cart): ?>
                                    <li class="cart-items">
                                        <div class="cart-img">
                                            <img src="{{asset('uploads/product_photos/')}}/{{App\Product::find($cart->product_id)->product_thamnel_photo}}" alt="" width="100">
                                        </div>
