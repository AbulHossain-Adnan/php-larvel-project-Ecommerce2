        ...
        <div class="swiper-container">
            ...
            <div class="swiper-wrapper">
                ...
                <div class="swiper-slide overlay">
                  @foreach ($sliders as $catala)
                    <div class="single-slider slide-inner" style="background: url({{ asset('uploads/slider_photos/')}}/{{ $catala->slider_photo }})">
                        <div class="container">
                            <div class="row">
                                <div class="col-lg-12 col-lg-9 col-12">
                                    <div class="slider-content">
                                        <div class="slider-shape">
                                            <h2 data-swiper-parallax="-500">{{ ($catala->slider_title) }}</h2>
                                            <p data-swiper-parallax="-400">{{ ($catala->slider_description) }}</p>
                      ...
                      @foreach ($categories as $category)
                        ...
                        <div class="featured-wrap">
                            <div class="featured-img">
                                <img src="{{ asset('uploads\categorys_photos')}}/{{ $category->category_photo }}" alt="">
              ...
              <?php foreach ($products as $product):?>
                ...
                <li class="col-xl-3 col-lg-4 col-sm-6 col-12">
                    <div class="product-wrap">
                        <div class="product-img">
                            <span>Sale</span>
                            <img src="frontend_assets/images/product/15.jpg" alt="">
                            <div class="product-icon flex-style">
                                <ul>
                                    <li><a data-toggle="modal" data-target="#exampleModalCenter" href="javascript:void(0);"><i class="fa fa-eye"></i></a></li>
                                    <li><a href="wishlist.html"><i class="fa fa-heart"></i></a></li>
                ...
                <div class="col-md-10 offset-md-1 col-12">
                    <div class="testmonial-active owl-carousel">
                        ...
                        <div class="test-items test-items2">
                            ...
                            <div class="test-img2">
                                <img src="frontend_assets/images/test/1.png" alt="">
                            </div>
                        </div>
                        <div class="test-items test-items2">
                            <div class="test-content">
